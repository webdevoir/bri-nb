                                        ...
                                        <div className="input-container">
                                            <div className="input-container-2">
                                                ...
                                                <div className="form-input">
                                                    <input type="email" placeholder="Email address" value={this.state.email} onChange={this.update("email")} className="login-input" />
                                                </div>
                                            </div>
                                        </div>
                                        <div className="input-container">
                                            <div className="input-container-2">
                                                ...
                                                <div className="form-input">
                                                    <input type="text" placeholder="First name" value={this.state.first_name} onChange={this.update("first_name")} className="login-input" />
                                                </div>
                                            </div>
                                        </div>
                                        <div className="input-container">
                                            <div className="input-container-2">
                                                ...
                                                <div className="form-input">
                                                    <input type="text" placeholder="Last name" value={this.state.last_name} onChange={this.update("last_name")} className="login-input" />
                                                </div>
                                            </div>
                                        </div>
                                        <div className="input-container">
                                            <div className="input-container-2">
                                                ...
                                                <div className="form-input">
                                                    <input type="password" placeholder="Create a Password" value={this.state.password} onChange={this.update("password")} className="login-input" />
                                                </div>
                                            </div>
                                        </div>
                                        <br />
